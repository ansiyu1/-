		...
		<div class="bgc-w box">
			...
			<div class="box-header">
				...
				<tr >
					...
					<td colspan="4" style="width:44px;"><div class="bottom">${map.deptname.deptName}</div></td>
					<td class="css" style="width:30px;"></td>
					<td class="wi"><label class="control-label">提单日期</label></td>
					<td colspan="4" ><div class="bottom">${(map.applytime)?string('yyyy-MM-dd HH:mm:ss')}</div></td>
				...
				<tr class="rile two">
					...
					<td  style="width:170px;"><div class="bottom">${map.startime?string('yyyy-MM-dd HH:mm:ss')}</div></td>
					<td class="css"style="width:30px;"></td>
					<td class="wi" style="width:90px;"><label class="control-label">结束日期</label></td>
					<td colspan="4" style="width:108px;"><div class="bottom">${map.endtime?string('yyyy-MM-dd HH:mm:ss')}</div></td>
					<td class="css" style="width:30px;"></td>
					...
					<div >
						<table class="table inside">
							...
							<tr class="tr">
									...
									<td colspan="2"><span>${tra.userName.userName}</span></td>
									<td colspan="2"><span>${tra.departTime ?string('yyyy-MM-dd HH:mm:ss')}</span></td>
					...
					<div >
						<table class="table inside">
							...
							<tr class="tr">
									...
									<td colspan="2"><span>${stay.userName.userName}</span></td>
									<td colspan="2"><span>${stay.stayTime?string('yyyy-MM-dd HH:mm:ss')}</span></td>
									<td colspan="2"><span>${stay.leaveTime?string('yyyy-MM-dd HH:mm:ss')}</span></td>

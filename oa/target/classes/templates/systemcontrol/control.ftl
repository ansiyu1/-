	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="jichu chat">
				...
				<a href="mail" class="moreduo"> 更多 <span
					class="glyphicon glyphicon-circle-arrow-right"></span>
				</a>
			</div>
		</div>
				...
				<div class="panel-heading box-show-heading"
					...
					<div class="pull-right right-btn-group dropdown"
						...
						<div style="display: inline-block;">
							...
							<ul class="dropdown-menu">
								<li><a href="newProcess">新建流程</a></li>
					...
					<table class="table table-hover" >
						<tr>
							...
							<tr>
								...
								<td>${(pro.applyTime)?string('yyyy-MM-dd HH:mm:ss')!''}</td>
					...
					<table class="table table-hover" >
						...
						<#list planList as plan>
							<tr>
								...
								<td>${(plan.endTime)?string('yyyy HH:mm:ss')!''}</td>
							...
							<p class="item-li-p">
								<a href="userpanel">${(np.title)!''} <small class="pull-right"
									style="color: #777;"><span
										class="glyphicon glyphicon-time"></span>${(np.createTime)?string('yyyy HH:mm:ss')!''}</small>
								</a><br> ${(np.concent)!''}
							</p></li>
							</#list>
					</ul>
